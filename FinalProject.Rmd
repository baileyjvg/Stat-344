...
summary(lm(baseball$HR ~ baseball$BB + baseball$Year, data = baseball))
anova(lm(baseball$HR ~ baseball$BB + baseball$Year, data = baseball))
baseball[[21]] <- as.factor(baseball[[21]])
HRchart <-data.frame(
...
```{r}
baseball[[21]] <- as.numeric(baseball[[21]])
summary(lm(baseball$SO ~ baseball$HR + baseball$Year, data = baseball))
anova(lm(baseball$SO ~ baseball$HR + baseball$Year, data = baseball))
baseball[[21]] <- as.factor(baseball[[21]])
SOchart <-data.frame(
